    ...
    <div class="flex justify-center items-center">
        @if($linkBookingLinks->isNotEmpty())
            <a href="{{ $linkBookingLinks->first()->url }}"
               ...
               class="btn bg-orange text-black rounded-full service5-btn-lg font-bold text-decoration-none"
               style="font-size: 1rem; font-weight: 700; padding: 1.5rem 4rem; font-weight: bold;">TANYA SEKARANG</a>
        @else
            <button type="button" class="btn bg-orange text-black rounded-full service5-btn-lg font-bold"
                style="font-size: 1rem; font-weight: 700; padding: 1.5rem 4rem; font-weight: bold;">TANYA SEKARANG</button>
        @endif
    </div>
</div>
        ...
        <div>
            @if($linkDaftarLinks->isNotEmpty())
                <a href="{{ $linkDaftarLinks->first()->url }}"
                   ...
                   class="btn btn-orange px-8 py-2 rounded-full service5-btn-lg font-bold text-decoration-none"
                   style="font-weight: bold; font-size: 15px;">DAFTAR</a>
            @else
                <button type="button" class="btn btn-orange px-8 py-2 rounded-full service5-btn-lg font-bold" style="font-weight: bold; font-size: 15px;">DAFTAR</button>
            @endif
        </div>
    </div>
</div>
